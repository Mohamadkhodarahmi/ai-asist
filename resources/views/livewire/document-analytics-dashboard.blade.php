                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                                    ...
                                    <div class="ml-4 flex-shrink-0">
                                        <div class="text-right">
                                            ...
                                            <p class="text-xs text-gray-600 dark:text-gray-400">success</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">No documents uploaded yet</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                            ...
                            @foreach($performanceStats['by_type'] as $typeData)
                                <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                                    ...
                                    <div class="grid grid-cols-3 gap-4 mt-2">
                                        <div>
                                            <p class="text-xs text-gray-600 dark:text-gray-400">Queries</p>
                                        ...
                                        <div>
                                            <p class="text-xs text-gray-600 dark:text-gray-400">Avg Time</p>
                                            <p class="text-sm font-semibold text-gray-900 dark:text-white">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">No analytics data available</p>
                        </div>
                    @endif
                </div>
            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider">Active Docs</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider">Queries</th>
